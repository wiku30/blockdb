...
// Test 4_3: Efficiency test_3: mostly GET, some valid withdrawals between 3 random accounts with 100 concurrent thread.
...
func main() {
	...
	// Prepare accounts
	clients[3].Put(ctx, &pb.Request{UserID: id(1), Value: int32(1000)})
	clients[3].Put(ctx, &pb.Request{UserID: id(2), Value: int32(1000)})
	clients[3].Put(ctx, &pb.Request{UserID: id(0), Value: int32(1000)})
	...
	log.Println("Test 4_3 Total IOPS:", iops)
